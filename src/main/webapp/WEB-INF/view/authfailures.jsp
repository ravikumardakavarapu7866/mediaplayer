...
<body>
	...
	<div class="container-fluid padding-container margin-Topbottom">
		...
		<div style="min-height:30px;">
			...
			<input type="hidden" id ="dgAuthFailuresPage" value = "${currentPage}" />

		</div>

		<div class="row g-0">

			<h4 style="font-weight: bold;background: #E3DEDD; width: 100%;padding-left:10px">Authorization Failures</h4>
		...
		<div class="row g-0">
			...
			<div class="col-md-12 col-lg-12 ">
				<ct:dataGrid dataSource="${authFailuresList}" keyField="id" id="dgAuthFailures" name="dgAuthFailures" startRecord="${startRecord}" currentPage="${currentPage}" pageSize="${pageSize}" gridHeight="${gridHeight}" totalRecords="${count}">
	...
	function dgAuthFailuresNavigate(strWhere, intPages, currentPage) {
		...
		if (intPg > 0) {
			document.getElementById("dgAuthFailuresPage").value = intPg;
			//showSpinner();
			...
			commonSearch(baseurl + "/authFailures", data, targetIds);
